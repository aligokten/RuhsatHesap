...
- `ORTAK`, `MERDIVEN`, `HOL`, `EMSAL`, `EMSAL_DISI` ve `SIGINAK` zonlarının ilgili ortak alan, yapı inşaat alanı, emsal ve sığınak modüllerine blok/kat bazında aktarılması
